        ...
        let commands = [{
            ...
            using: {
                ...
                strokeStyle: {
                    ...
                    strokeStyleLineCap: { _enum: "strokeStyleLineCap", _value: "strokeStyleRoundCap" },
                    strokeStyleContent: {
                        _obj: "solidColorLayer",
                        color: {
                            _obj: "RGBColor",
    ...
    await execute(async () => {
        let pathPoints = points.map((p) => {
            ...
            if (p.leftDirection) {
                desc.leftDirection = {
                    _obj: "paint",
                    horizontal: { _unit: "pixelsUnit", _value: p.leftDirection.x },
                    vertical: { _unit: "pixelsUnit", _value: p.leftDirection.y },
                };
            }
            ...
            if (p.rightDirection) {
                desc.rightDirection = {
                    _obj: "paint",
                    horizontal: { _unit: "pixelsUnit", _value: p.rightDirection.x },
                    vertical: { _unit: "pixelsUnit", _value: p.rightDirection.y },
                };
            }
                        ...
                        subpathListKey: [
                            {
                                ...
                                points: [
                                    {
                                        _obj: "pathPoint",
                                        anchor: { _obj: "paint", horizontal: { _unit: "pixelsUnit", _value: startPoint.x }, vertical: { _unit: "pixelsUnit", _value: startPoint.y } },
                                    },
                                    {
                                        _obj: "pathPoint",
                                        anchor: { _obj: "paint", horizontal: { _unit: "pixelsUnit", _value: baseX }, vertical: { _unit: "pixelsUnit", _value: baseY } },
                                    },
                                ],
                            },
                            {
                                ...
                                points: [
                                    {
                                        _obj: "pathPoint",
                                        anchor: { _obj: "paint", horizontal: { _unit: "pixelsUnit", _value: endPoint.x }, vertical: { _unit: "pixelsUnit", _value: endPoint.y } },
                                    },
                                    {
                                        _obj: "pathPoint",
                                        anchor: { _obj: "paint", horizontal: { _unit: "pixelsUnit", _value: wingL.x }, vertical: { _unit: "pixelsUnit", _value: wingL.y } },
                                    },
                                    {
                                        _obj: "pathPoint",
                                        anchor: { _obj: "paint", horizontal: { _unit: "pixelsUnit", _value: wingR.x }, vertical: { _unit: "pixelsUnit", _value: wingR.y } },
                                    },
                                ],
                            },
                        ],
